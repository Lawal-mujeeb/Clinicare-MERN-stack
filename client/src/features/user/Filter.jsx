...
export default function Filter() {
  ...
  const handleSubmit = (event) => {
    ...
    const updatedSearchParams = new URLSearchParams(searchParams); //Think of searchParams as the current filters sitting in the URL (like ?role=doctor&status=active).This line makes a copy called updatedSearchParams that we can edit safely without directly mutating the original.
